...
<head>
	...
	<meta name="description" content="Halaman tidak ditemukan - Turen Indah Bangunan">

	<!-- title -->
	<title>404 - Halaman Tidak Ditemukan | Turen Indah Bangunan</title>
					...
					<div class="row">
						<div class="col-lg-8 offset-lg-2 text-center">
							<div class="error-text">
								...
								<p>Halaman yang Anda cari tidak dapat ditemukan. Mungkin telah dipindahkan atau dihapus.</p>
								<a href="<?= BASE_URL ?>" class="boxed-btn">Kembali ke Beranda</a>
							</div>
						</div>
					</div>
				</div>
